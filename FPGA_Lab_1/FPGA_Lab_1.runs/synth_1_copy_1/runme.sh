...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_1/FPGA_Lab_1.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log Probem_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Probem_2.tcl
