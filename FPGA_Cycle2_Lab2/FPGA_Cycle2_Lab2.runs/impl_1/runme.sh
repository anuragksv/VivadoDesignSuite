...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Cycle2_Lab2/FPGA_Cycle2_Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HT12E_D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HT12E_D.tcl -notrace
