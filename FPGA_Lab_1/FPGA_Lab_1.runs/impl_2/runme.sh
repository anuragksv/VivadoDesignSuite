...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_1/FPGA_Lab_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Probem_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Probem_2.tcl -notrace
