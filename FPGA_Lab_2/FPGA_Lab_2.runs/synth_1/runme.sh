...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_2/FPGA_Lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Rising_Edge_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Rising_Edge_LED.tcl
