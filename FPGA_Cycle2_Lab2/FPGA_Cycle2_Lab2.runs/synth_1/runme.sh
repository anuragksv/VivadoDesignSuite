...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Cycle2_Lab2/FPGA_Cycle2_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HT12E_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HT12E_D.tcl
