...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_Exam_1/FPGA_Lab_Exam_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_Machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mealy_Machine.tcl -notrace
