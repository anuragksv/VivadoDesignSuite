...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_Exam_1/FPGA_Lab_Exam_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_Machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mealy_Machine.tcl
