...
HD_PWD='D:/git/VivadoDesignSuite/FPGA_Lab_2/FPGA_Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Rising_Edge_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Rising_Edge_LED.tcl -notrace
